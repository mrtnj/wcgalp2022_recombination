...
cols <- c("gen",
          "average_mean_g", "sd_mean_g", "lower_mean_g", "upper_mean_g",
          "average_var_a", "sd_var_a", "lower_var_a", "upper_var_a",
          "average_accuracy", "sd_accuracy", "lower_accuracy", "upper_accuracy",
          "case", "total_n_qtl")
